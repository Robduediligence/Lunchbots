...
Return ONLY valid JSON.`,
  ...
  return (
    <div style={{ background:'#0f0f1a', border:'1px solid rgba(124,58,237,0.2)', borderRadius:10, padding:16, display:'flex', flexDirection:'column', height:'100%', boxSizing:'border-box' }}>
